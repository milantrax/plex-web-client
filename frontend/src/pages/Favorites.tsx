...
import type { Favorite, PlexAlbum, PlexArtist, PlexTrack } from '../types';
...
export function FavoriteAlbums() {
  ...
  const albums: PlexAlbum[] = favorites
...
export function FavoriteArtists() {
  ...
  const artists: PlexArtist[] = favorites
...
export function FavoritePlaylists() {
  ...
  const getPlaylistRoute = (pl: Favorite) =>
    pl.subtitle === 'custom'
...
export function FavoriteTracks() {
  ...
  const tracks: PlexTrack[] = favorites
