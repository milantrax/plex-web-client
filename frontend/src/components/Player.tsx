...
/** Imperative API exposed to the PlaybackContext via ref. */
...
export interface PlayerProps {
  ...
  onTrackEnded?: (track: PlexTrack) => void;
  onPlayNext?: (track: PlexTrack) => void;
  onPlayPrevious?: (track: PlexTrack) => void;
}
...
const Player = forwardRef<PlayerHandle, PlayerProps>(({ currentTrack, onPlayStateChange, onTrackEnded, onPlayNext, onPlayPrevious }, ref) => {
  ...
  const handleEnded = () => {
    ...
    // currentTrack is always set here: the element only reaches 'ended' with a
    // loaded source. The guard keeps the handler's non-null contract explicit.
    if (onTrackEnded && currentTrack) {
