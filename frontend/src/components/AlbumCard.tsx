...
export interface AlbumCardProps {
  ...
  isArtist?: boolean;
  showTrackMatch?: boolean;
}

function AlbumCard({ album, onPlayTrack, currentTrack, isPlaying, onTogglePlayback, isArtist = false, showTrackMatch = false }: AlbumCardProps) {
  ...
  useEffect(() => {
    const handleWidthChange = (event: AlbumCardWidthChangedEvent) => {
  ...
  const handlePlayPauseClick = async (e: React.MouseEvent<HTMLButtonElement>) => {
    e.stopPropagation();
