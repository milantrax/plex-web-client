...
import type { PlexArtist } from '../types';
...
function Artists() {
  ...
  const groupArtistsByLetter = (artists: PlexArtist[]): LetterGroup[] => {
    const grouped = artists.reduce<Record<string, PlexArtist[]>>((acc, artist) => {
